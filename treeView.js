...
{	
    ...
    getChildren()
    {
		...
		cmds[2] = new TreeCmd("mycmd", "Flutter Commands: Build APK App Bundle", 
		vscode.TreeItemCollapsibleState.None, { command: 'fluttercmd.executecmd', title: "Execute" ,arguments: ["5"] });		
		cmds[3] = new TreeCmd("mycmd", "Flutter Commands: Repair Imports", 
		vscode.TreeItemCollapsibleState.None, { command: 'fluttercmd.executecmd', title: "Execute" ,arguments: ["3"] });		
		cmds[4] = new TreeCmd("mycmd", "Flutter Commands: Repair Project", 
